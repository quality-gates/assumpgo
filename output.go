...
func runeWidth(r rune) int {
	...
	// Regional indicators are one column each, so a flag pair occupies two
	// columns. U+2764 is also narrow, despite falling in the broad symbol range.
	if r == 0x2764 || (r >= 0x1f1e6 && r <= 0x1f1ff) {
		return 1
	}
